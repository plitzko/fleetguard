# FleetGuard – Predictive Maintenance MVP
...
Ein klickbarer Prototyp mit drei Screens:
...
3. **Alert-Feed** – Chronologische Liste aller Warnungen, Filter nach Schweregrad
...
1. **Flottenübersicht öffnen** – "Hier sieht Thomas, der Flottenmanager, alle 10 LKW auf einen Blick. LKW-01 ist rot, ganz oben sortiert. Die KPI-Cards zeigen sofort: ein Fahrzeug kritisch, zwei gewarnt, sieben OK. Geschätzte verhinderte Kosten: 2.400 €."
...
Alle drei Screens lesen ausschließlich CSV. Sobald das Backend läuft, tauschen wir die Datenquelle aus – die UI bleibt 1:1 gleich. Das ist der Sinn dieses Prototypen.
